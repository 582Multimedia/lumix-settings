...
1. Press [ MENU ].
2. Select [ SETUP ![Settings Icon](/docs/images/Setupicon.png) <img src="/docs/images/Setupicon.png" width="32" height="32"> ].
3. Select [ Card/File ![SD Card Icon](/docs/images/insertsdcardS1.png) <img src="/docs/images/insertsdcardS1.png" width="32" height="32"> ].
